          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 sm:gap-4 mt-4">
            <div className="flex flex-col items-center">
              ...
              <div className="flex flex-col py-4">
                ...
                <span className="text-sm">February 01, 2024</span>
              </div>
            </div>
            <div className="flex flex-col items-center">
              <img
              ...
              <div className="flex flex-col py-4">
                ...
                <span className="text-sm">February 20, 2024</span>
              </div>
            </div>
            <div className="flex flex-col items-center">
              <img
              ...
              <div className="flex flex-col py-4">
                ...
                <span className="text-sm">January 12, 2024</span>
              </div>
            </div>
            <div className="flex flex-col items-center">
              <img
              ...
              <div className="flex flex-col py-4">
                ...
                <span className="text-sm">January 01, 2024</span>
              </div>
            </div>
          </div>
        </section>
