...
const Register = (): JSX.Element => {
  ...
  return (
    <AuthLayout title={EN.PAGES.REGISTER.TITLE}>
      <AuthForm<RegisterValues>
        loading={loading}
        alert={alert}
        submitText={EN.PAGES.REGISTER.BUTTON}
        onSubmit={async e => {
        ...
        <AuthLink route={ROUTES.LOGIN} text={EN.AUTH.LINKALREDYREGISTERED} />
      </AuthForm>
    </AuthLayout>
  );
};
