...
describe("ProtectedLayout", () => {
  ...
  test("renders Account when authenticated", () => {
    ...
    expect(screen.getByText(EN.PAGES.ACCOUNT.USERDATA.TITLE)).toBeInTheDocument();
    expect(screen.getByText(EN.PAGES.ACCOUNT.CHANGEPASSWORD.TITLE)).toBeInTheDocument();
  });
});
